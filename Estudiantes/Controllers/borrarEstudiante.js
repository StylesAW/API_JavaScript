...
function mostrarModalBorrarEstudiante(id,cedula, nombre) {
  modalEliminar.show();
  document.getElementById("estudianteIdEliminar").value = id;
...
function borrarEstudiante() {
  let id = document.getElementById("estudianteIdEliminar").value;
  var datosEnviar = {
    id: id
  };

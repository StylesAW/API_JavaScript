      ...
      contenidoTablaResultado.innerHTML += `
        <tr class="table-primary">
          ...
          <td>
            ...
            onClick="modificarEstudiante('${valor.id}','${valor.cedula}','${valor.correoelectronico}','${valor.telefono}','${valor.telefonocelular}',
            ...
            >Editar</button> || <button type="button" class="btn btn-danger" onClick="mostrarModalBorrarEstudiante('${valor.id}','${valor.cedula}','${valor.nombre}')">Borrar</button>
          </td>
        </tr>`;
    }
  }

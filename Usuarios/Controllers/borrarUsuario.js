...
function mostrarModalBorrarUsuario(id,cedula, nombre) {
  modalEliminar.show();
...
function borrarUsuario() {
  let id = document.getElementById("usuarioIdEliminar").value;
  var datosEnviar = {
    id: id
  };
  fetch("https://paginas-web-cr.com/ApiPHP/apis/BorrarUsuarios.php",
    {
      method: 'POST',

...
function modificarProfesor(id,cedula,correoelectronico,telefono,telefonocelular,fechanacimiento,sexo,direccion,nombre,apellidopaterno,apellidomaterno,nacionalidad,idCarreras,usuario) {
    myModal.show();
  ...
  formulario.addEventListener('submit', function (e) {
    ...
    console.log("holis")
    let id = document.getElementById("profesorId").value;
